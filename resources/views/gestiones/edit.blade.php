                            ...
                            <div class="nk-content-body">
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Editar Gestión</h3>
                                ...
                                <div class="card card-preview">
                                    <div class="card-inner">
                                        <form class="row gy-2 form-validate" action="{{ route('gestion.update', $gestion->id) }}" method="POST">
                                            @csrf
                                            @method('PUT')
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <select class="form-select form-control form-control-lg" data-search="on"
                                                            ...
                                                            <option value="{{ $item->id }}" @if ($gestion->client_id == $item->id) selected @endif >{{ $item->firstname }} {{ $item->second_name }} {{ $item->lastname }} {{ $item->second_surname }}</option>
                                                            @endforeach
                                                        </select>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <textarea class="form-control no-resize" name="task" id="task">{{ $gestion->task }}</textarea>
                                                        @if ($errors->has('task'))
                                                            <span class="invalid text-danger">
                                                                {{ $errors->first('task') }}
                                                            </span>
