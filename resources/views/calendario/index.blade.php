                        ...
                        <div class="nk-content-inner">
                            <div class="nk-content-body">
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Calendario</h3>
                                ...
                                <div class="nk-block">
                                    ...
                                    @include('calendario.partials.modal-create')
                                    @include('calendario.partials.modal-show')
                                    @include('calendario.partials.modal-delete')
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
...
@section('scripts')
        ...
        <script>
            ...
            var $win = $(window),
                $body = $('body'),
                breaks = NioApp.Break,
                url = "{{ route('appointment.appointmentJson') }}";
            ...
            NioApp.Calendar = function () {
                ...
                deleteEventBtn.on("click", function (e) {
                    ...
                    var urlBase = "{{ url('') }}";
                    var deleteUrl = urlBase +'/citas/'+dataId+'/eliminar-cita';
                    $.ajax({
                        url: deleteUrl,
                        type: 'POST',
                        data: {},
